...
create_clock -name     "clk"       \
    ...
    [get_ports [lindex $CLK_PORT]]

set_ideal_network [get_nets reset] -no_propagate

# global margin
set_critical_range $clk_critical_range $current_design
# uncertainty
set_clock_uncertainty -setup ${clk_setup_uncertainty} [get_clocks]
set_clock_uncertainty -hold ${clk_hold_uncertainty}  [get_clocks]
# transition
set_clock_transition ${clk_trans} [get_clocks]
set_fix_hold [get_clocks]

set_ideal_network [get_nets [list dataOut instr]] -no_propagate
# set_false_path -through [ get_pins sm0/* ]
# set_max_transition 1 [ get_pins sm0/* ]
...
foreach_in_collection clk [get_clocks] {
    ...
    # inputs 
    set_input_delay $blanket_input_delay -clock $clk [remove_from_collection [all_inputs] [get_ports $CLK_PORT]]

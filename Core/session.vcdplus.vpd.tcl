...
#   Group cpuStim_1 signal count = 11
#   Group registers signal count = 13
#   Group controlUnit signal count = 20
#   Group aluBlock signal count = 12
#   Group forward signal count = 8
...
gui_set_radix -radix {decimal} -signals {V1:cpuStim.testCpu.registers.r15}
gui_set_radix -radix {unsigned} -signals {V1:cpuStim.testCpu.registers.r15}
...
gui_set_radix -radix {unsigned} -signals {V1:cpuStim.testCpu.forward.RA2}
...
gui_set_radix -radix twosComplement -signal {{cpuStim.testCpu.registers.MEM[13]}}
...
gui_set_radix -radix twosComplement -signal {{cpuStim.testCpu.registers.MEM[12]}}
...
gui_set_radix -radix twosComplement -signal {{cpuStim.testCpu.registers.MEM[11]}}
...
gui_set_radix -radix twosComplement -signal {{cpuStim.testCpu.registers.MEM[10]}}
...
gui_set_radix -radix twosComplement -signal {{cpuStim.testCpu.registers.MEM[9]}}
...
gui_set_radix -radix twosComplement -signal {{cpuStim.testCpu.registers.MEM[8]}}
...
gui_set_radix -radix twosComplement -signal {{cpuStim.testCpu.registers.MEM[7]}}
...
gui_set_radix -radix twosComplement -signal {{cpuStim.testCpu.registers.MEM[6]}}
...
gui_set_radix -radix twosComplement -signal {{cpuStim.testCpu.registers.MEM[5]}}
...
gui_set_radix -radix twosComplement -signal {{cpuStim.testCpu.registers.MEM[4]}}
...
gui_set_radix -radix twosComplement -signal {{cpuStim.testCpu.registers.MEM[3]}}
...
gui_set_radix -radix twosComplement -signal {{cpuStim.testCpu.registers.MEM[2]}}
...
gui_set_radix -radix twosComplement -signal {{cpuStim.testCpu.registers.MEM[1]}}
...
gui_set_radix -radix twosComplement -signal {{cpuStim.testCpu.registers.MEM[0]}}

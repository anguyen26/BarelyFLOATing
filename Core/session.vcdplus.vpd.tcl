...
# DVE full session
# Saved on Tue May 3 11:34:16 2022
# Designs open: 1
#   V1: vcdplus.vpd
...
#   Group cpuStim_1 signal count = 10
...
#   Group shiftBlock signal count = 4
#   Group dataMemory signal count = 8
...
gui_show_window -window ${TopLevel.1} -show_state normal -rect {{-4 99} {743 885}}
...
set HSPane.1 [gui_create_window -type HSPane -parent ${TopLevel.1} -dock_state left -dock_on_new_line true -dock_extent 367]
catch { set Hier.1 [gui_share_window -id ${HSPane.1} -type Hier] }
gui_set_window_pref_key -window ${HSPane.1} -key dock_width -value_type integer -value 367
gui_set_window_pref_key -window ${HSPane.1} -key dock_height -value_type integer -value -1
gui_set_window_pref_key -window ${HSPane.1} -key dock_offset -value_type integer -value 0
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 366} {height 418} {dock_state left} {dock_on_new_line true} {child_hier_colhier 255} {child_hier_coltype 88} {child_hier_colpd 0} {child_hier_col1 0} {child_hier_col2 1} {child_hier_col3 -1}}
...
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 391} {height 418} {dock_state left} {dock_on_new_line true} {child_data_colvariable 194} {child_data_colvalue 105} {child_data_coltype 94} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
set Console.1 [gui_create_window -type Console -parent ${TopLevel.1} -dock_state bottom -dock_on_new_line true -dock_extent 236]
gui_set_window_pref_key -window ${Console.1} -key dock_width -value_type integer -value 755
gui_set_window_pref_key -window ${Console.1} -key dock_height -value_type integer -value 236
gui_set_window_pref_key -window ${Console.1} -key dock_offset -value_type integer -value 0
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 747} {height 235} {dock_state bottom} {dock_on_new_line true}}
...
gui_show_window -window ${TopLevel.2} -show_state maximized -rect {{874 122} {1633 918}}
...
gui_update_layout -id ${Wave.1} {{show_state maximized} {dock_state undocked} {dock_on_new_line false} {child_wave_left 321} {child_wave_right 433} {child_wave_colname 202} {child_wave_colvalue 115} {child_wave_col1 0} {child_wave_col2 1}}
...
# Global: Bus
gui_bus_create -name EXP:instrNum {{cpuStim.testCpu.PC[15]} {cpuStim.testCpu.PC[14]} {cpuStim.testCpu.PC[13]} {cpuStim.testCpu.PC[12]} {cpuStim.testCpu.PC[11]} {cpuStim.testCpu.PC[10]} {cpuStim.testCpu.PC[9]} {cpuStim.testCpu.PC[8]} {cpuStim.testCpu.PC[7]} {cpuStim.testCpu.PC[6]} {cpuStim.testCpu.PC[5]} {cpuStim.testCpu.PC[4]} {cpuStim.testCpu.PC[3]} {cpuStim.testCpu.PC[2]}}
gui_bus_create -name EXP:instrLineNum {{cpuStim.testCpu.PC[15]} {cpuStim.testCpu.PC[14]} {cpuStim.testCpu.PC[13]} {cpuStim.testCpu.PC[12]} {cpuStim.testCpu.PC[11]} {cpuStim.testCpu.PC[10]} {cpuStim.testCpu.PC[9]} {cpuStim.testCpu.PC[8]} {cpuStim.testCpu.PC[7]} {cpuStim.testCpu.PC[6]} {cpuStim.testCpu.PC[5]} {cpuStim.testCpu.PC[4]}}
...
gui_set_radix -radix {decimal} -signals {EXP:instrNum}
gui_set_radix -radix {unsigned} -signals {EXP:instrNum}
...
append _session_group_121 regWrMux
gui_sg_create "$_session_group_121"
set registers|regWrMux "$_session_group_121"

gui_sg_addsignal -group "$_session_group_121" { cpuStim.testCpu.regWrMux.i0 cpuStim.testCpu.regWrMux.i1 cpuStim.testCpu.regWrMux.i2 cpuStim.testCpu.regWrMux.i3 cpuStim.testCpu.regWrMux.sel cpuStim.testCpu.regWrMux.out }
...
set _session_group_123 aluBlock
gui_sg_create "$_session_group_123"
set aluBlock "$_session_group_123"

gui_sg_addsignal -group "$_session_group_123" { cpuStim.testCpu.aluBlock.a cpuStim.testCpu.aluBlock.b cpuStim.testCpu.aluBlock.ALUControl cpuStim.testCpu.aluBlock.Result cpuStim.testCpu.aluBlock.ALUFlags cpuStim.testCpu.aluBlock.temp_op cpuStim.testCpu.aluBlock.carry cpuStim.testCpu.aluBlock.adder_out cpuStim.testCpu.aluBlock.SIZE cpuStim.testCpu.instructionMemory.address cpuStim.testCpu.instructionMemory.instruction cpuStim.testCpu.instructionMemory.clk cpuStim.testCpu.instructionMemory.i cpuStim.testCpu.instructionMemory.mem }
gui_set_radix -radix {decimal} -signals {V1:cpuStim.testCpu.aluBlock.adder_out}
gui_set_radix -radix {unsigned} -signals {V1:cpuStim.testCpu.aluBlock.adder_out}
...
set _session_group_124 Group2
gui_sg_create "$_session_group_124"
set Group2 "$_session_group_124"

gui_sg_addsignal -group "$_session_group_124" { cpuStim.testCpu.regWriteMux.i0 cpuStim.testCpu.regWriteMux.i1 cpuStim.testCpu.regWriteMux.i2 cpuStim.testCpu.regWriteMux.i3 cpuStim.testCpu.regWriteMux.sel cpuStim.testCpu.regWriteMux.out }

set _session_group_125 shiftBlock
gui_sg_create "$_session_group_125"
set shiftBlock "$_session_group_125"

gui_sg_addsignal -group "$_session_group_125" { cpuStim.testCpu.shiftBlock.value cpuStim.testCpu.shiftBlock.mode cpuStim.testCpu.shiftBlock.distance cpuStim.testCpu.shiftBlock.result }

set _session_group_126 dataMemory
gui_sg_create "$_session_group_126"
set dataMemory "$_session_group_126"

gui_sg_addsignal -group "$_session_group_126" { {cpuStim.testCpu.dataMemory.unnamed$$_0} cpuStim.testCpu.dataMemory.mem cpuStim.testCpu.dataMemory.address cpuStim.testCpu.dataMemory.write_enable cpuStim.testCpu.dataMemory.read_enable cpuStim.testCpu.dataMemory.write_data cpuStim.testCpu.dataMemory.clk cpuStim.testCpu.dataMemory.read_data }
gui_set_radix -radix {decimal} -signals {V1:cpuStim.testCpu.dataMemory.address}
gui_set_radix -radix {unsigned} -signals {V1:cpuStim.testCpu.dataMemory.address}
...
gui_view_scroll -id ${Hier.1} -vertical -set 151
...
gui_wv_zoom_timerange -id ${Wave.1} 191724 320475
...
gui_list_add_group -id ${Wave.1} -after {New Group} {shiftBlock}
gui_list_add_group -id ${Wave.1} -after {New Group} {dataMemory}
gui_list_collapse -id ${Wave.1} registers|regWrMux
gui_list_expand -id ${Wave.1} cpuStim.testCpu.registers.MEM
gui_list_select -id ${Wave.1} {EXP:instrNum }
...
gui_list_set_insertion_bar  -id ${Wave.1} -group cpuStim_1  -item EXP:instrNum -position below

gui_marker_move -id ${Wave.1} {C1} 261866
gui_view_scroll -id ${Wave.1} -vertical -set 27

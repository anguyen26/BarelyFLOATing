...
# DVE full session
# Saved on Fri Apr 29 08:00:08 2022
# Designs open: 1
...
gui_show_window -window ${TopLevel.2} -show_state normal -rect {{507 104} {1712 897}}
...
gui_update_layout -id ${Wave.1} {{show_state maximized} {dock_state undocked} {dock_on_new_line false} {child_wave_left 590} {child_wave_right 610} {child_wave_colname 175} {child_wave_colvalue 411} {child_wave_col1 0} {child_wave_col2 1}}
...
gui_sg_addsignal -group "$_session_group_6" { cpuStim.testCpu.brSel cpuStim.testCpu.branchAddr cpuStim.testCpu.branchAddr cpuStim.testCpu.branchAddr cpuStim.testCpu.branchAddr cpuStim.testCpu.branchAddr cpuStim.testCpu.pcOffset cpuStim.testCpu.brancherAdder.cout cpuStim.testCpu.brancherAdder.in1 cpuStim.testCpu.brancherAdder.in2 cpuStim.testCpu.brancherAdder.middleCarryOuts cpuStim.testCpu.brancherAdder.out }
...
gui_wv_zoom_timerange -id ${Wave.1} 128038 153663
...
gui_marker_move -id ${Wave.1} {C1} 15050

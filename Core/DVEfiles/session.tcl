...
# DVE full session
# Saved on Mon May 2 02:09:09 2022
# Designs open: 1
#   V1: /home/projects/ee478.2022spr/hoppii/BarelyFLOATing/Core/vcdplus.vpd
...
#<Session mode="Full" path="/home/projects/ee478.2022spr/hoppii/BarelyFLOATing/Core/DVEfiles/session.tcl" type="Debug">
...
gui_show_window -window ${TopLevel.1} -show_state normal -rect {{529 188} {1276 974}}
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 366} {height 500} {dock_state left} {dock_on_new_line true} {child_hier_colhier 255} {child_hier_coltype 88} {child_hier_colpd 0} {child_hier_col1 0} {child_hier_col2 1} {child_hier_col3 -1}}
...
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 391} {height 500} {dock_state left} {dock_on_new_line true} {child_data_colvariable 194} {child_data_colvalue 105} {child_data_coltype 94} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
...
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 747} {height 153} {dock_state bottom} {dock_on_new_line true}}
...
if { ![gui_is_db_opened -db {/home/projects/ee478.2022spr/hoppii/BarelyFLOATing/Core/vcdplus.vpd}] } {
	gui_open_db -design V1 -file /home/projects/ee478.2022spr/hoppii/BarelyFLOATing/Core/vcdplus.vpd -nosource
}

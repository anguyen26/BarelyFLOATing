...
# DVE full session
# Saved on Sat Apr 30 00:27:20 2022
# Designs open: 1
...
#   Group registers signal count = 13
#   Group controlUnit signal count = 17
...
gui_show_window -window ${TopLevel.1} -show_state normal -rect {{4 70} {757 862}}
...
set HSPane.1 [gui_create_window -type HSPane -parent ${TopLevel.1} -dock_state left -dock_on_new_line true -dock_extent 518]
catch { set Hier.1 [gui_share_window -id ${HSPane.1} -type Hier] }
gui_set_window_pref_key -window ${HSPane.1} -key dock_width -value_type integer -value 518
gui_set_window_pref_key -window ${HSPane.1} -key dock_height -value_type integer -value -1
gui_set_window_pref_key -window ${HSPane.1} -key dock_offset -value_type integer -value 0
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 517} {height 500} {dock_state left} {dock_on_new_line true} {child_hier_colhier 395} {child_hier_coltype 180} {child_hier_colpd 0} {child_hier_col1 0} {child_hier_col2 1} {child_hier_col3 -1}}
...
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 397} {height 500} {dock_state left} {dock_on_new_line true} {child_data_colvariable 194} {child_data_colvalue 105} {child_data_coltype 94} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
...
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 753} {height 159} {dock_state bottom} {dock_on_new_line true}}
...
gui_sg_addsignal -group "$_session_group_2" { cpuStim.ClockDelay cpuStim.clk cpuStim.reset cpuStim.testCpu.PC cpuStim.testCpu.PCNext cpuStim.testCpu.instr }
...
gui_sg_addsignal -group "$_session_group_3" { cpuStim.testCpu.controlUnit.RegWrite cpuStim.testCpu.controlUnit.Reg1Loc cpuStim.testCpu.controlUnit.Reg2Loc cpuStim.testCpu.controlUnit.Reg3Loc cpuStim.testCpu.registers.wr_data cpuStim.testCpu.registers.rd_addr_0 cpuStim.testCpu.registers.rd_addr_1 cpuStim.testCpu.registers.wr_addr cpuStim.testCpu.registers.wr_en cpuStim.testCpu.registers.rd_data_0 cpuStim.testCpu.registers.rd_data_1 cpuStim.testCpu.registers.MEM cpuStim.testCpu.registers.clk }
...
set _session_group_4 controlUnit
gui_sg_create "$_session_group_4"
set controlUnit "$_session_group_4"

gui_sg_addsignal -group "$_session_group_4" { cpuStim.testCpu.controlUnit.PC cpuStim.testCpu.controlUnit.instr cpuStim.testCpu.controlUnit.FlagsReg cpuStim.testCpu.controlUnit.clk cpuStim.testCpu.controlUnit.reset cpuStim.testCpu.controlUnit.MemWrite cpuStim.testCpu.controlUnit.MemRead cpuStim.testCpu.controlUnit.ShiftDir cpuStim.testCpu.controlUnit.noop cpuStim.testCpu.controlUnit.keepFlags cpuStim.testCpu.controlUnit.selOpB cpuStim.testCpu.controlUnit.selOpA cpuStim.testCpu.controlUnit.ALUOp cpuStim.testCpu.controlUnit.brSel cpuStim.testCpu.controlUnit.brEx cpuStim.testCpu.controlUnit.selWrData cpuStim.testCpu.controlUnit.opcode }
gui_set_radix -radix {binary} -signals {V1:cpuStim.testCpu.controlUnit.instr}
gui_set_radix -radix {unsigned} -signals {V1:cpuStim.testCpu.controlUnit.instr}
...
catch {gui_list_select -id ${Hier.1} {cpuStim.testCpu.controlUnit}}
...
gui_list_show_data -id ${Data.1} {cpuStim.testCpu.controlUnit}

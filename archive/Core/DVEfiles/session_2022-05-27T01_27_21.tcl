...
# DVE full session
# Saved on Fri May 27 01:27:21 2022
# Designs open: 1
...
gui_show_window -window ${TopLevel.3} -show_state normal -rect {{0 67} {770 855}}
...
set HSPane.1 [gui_create_window -type HSPane -parent ${TopLevel.3} -dock_state left -dock_on_new_line true -dock_extent 325]
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 324} {height 655} {dock_state left} {dock_on_new_line true} {child_hier_colhier 261} {child_hier_coltype 94} {child_hier_colpd 0} {child_hier_col1 0} {child_hier_col2 1} {child_hier_col3 -1}}
...
gui_update_layout -id ${DLPane.1} {{show_state maximized} {dock_state undocked} {dock_on_new_line false} {child_data_colvariable 211} {child_data_colvalue 118} {child_data_coltype 112} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
...
set _session_group_261 cpuControl_testbench
gui_sg_create "$_session_group_261"
set cpuControl_testbench "$_session_group_261"


set _session_group_262 cpuStim_1
gui_sg_create "$_session_group_262"
set cpuStim_1 "$_session_group_262"

gui_sg_addsignal -group "$_session_group_262" { cpuStim.testCpu.clk cpuStim.testCpu.reset cpuStim.testCpu.PC cpuStim.testCpu.PCNext cpuStim.testCpu.instr }
...
set _session_group_263 registers
gui_sg_create "$_session_group_263"
set registers "$_session_group_263"

gui_sg_addsignal -group "$_session_group_263" { }

set _session_group_264 $_session_group_263|
append _session_group_264 registers
gui_sg_create "$_session_group_264"
set registers|registers "$_session_group_264"

gui_sg_addsignal -group "$_session_group_264" { cpuStim.testCpu.registers.MEM cpuStim.testCpu.registers.wr_en cpuStim.testCpu.registers.wr_data cpuStim.testCpu.registers.wr_addr cpuStim.testCpu.registers.rd_addr_0 cpuStim.testCpu.registers.rd_addr_1 cpuStim.testCpu.registers.rd_data_0 cpuStim.testCpu.registers.rd_data_1 }
...
set _session_group_268 Regfile
gui_sg_create "$_session_group_268"
set Regfile "$_session_group_268"

gui_sg_addsignal -group "$_session_group_268" { cpuStim.testCpu.ALUorFPUE cpuStim.testCpu.registers.MEM cpuStim.testCpu.registers.rd_addr_0 cpuStim.testCpu.registers.rd_addr_1 cpuStim.testCpu.wasFPU cpuStim.testCpu.regWriteAddrDefault cpuStim.testCpu.FPUWrAddr cpuStim.testCpu.RegWriteE cpuStim.testCpu.registers.wr_data cpuStim.testCpu.registers.wr_addr cpuStim.testCpu.RegWrite cpuStim.testCpu.registers.wr_en cpuStim.testCpu.CompOutput cpuStim.testCpu.registers.rd_data_0 cpuStim.testCpu.registers.rd_data_1 }
gui_set_radix -radix {decimal} -signals {V1:cpuStim.testCpu.registers.MEM}
gui_set_radix -radix {unsigned} -signals {V1:cpuStim.testCpu.registers.MEM}
gui_set_radix -radix {decimal} -signals {V1:cpuStim.testCpu.registers.rd_addr_0}
gui_set_radix -radix {unsigned} -signals {V1:cpuStim.testCpu.registers.rd_addr_0}
...
set _session_group_269 {Top Level}
gui_sg_create "$_session_group_269"
set {Top Level} "$_session_group_269"

gui_sg_addsignal -group "$_session_group_269" { cpuStim.testCpu.clk cpuStim.testCpu.reset cpuStim.testCpu.PC EXP:LineNum cpuStim.testCpu.PCNext cpuStim.testCpu.PCE cpuStim.testCpu.PCNext_preStall cpuStim.testCpu.PCPlus1 cpuStim.testCpu.instr cpuStim.testCpu.instrE cpuStim.testCpu.stallF cpuStim.testCpu.controlUnit.ALUorFPU cpuStim.testCpu.Branch cpuStim.testCpu.BranchE cpuStim.testCpu.Branch_pre }
gui_set_radix -radix {decimal} -signals {V1:cpuStim.testCpu.PC}
gui_set_radix -radix {twosComplement} -signals {V1:cpuStim.testCpu.PC}
...
set _session_group_270 FPU
gui_sg_create "$_session_group_270"
set FPU "$_session_group_270"

gui_sg_addsignal -group "$_session_group_270" { cpuStim.testCpu.FPU.opA cpuStim.testCpu.FPU.opB EXP:mantA EXP:mantB EXP:expA EXP:expB }
gui_sg_addsignal -group "$_session_group_270" { Divider } -divider
gui_sg_addsignal -group "$_session_group_270" { cpuStim.testCpu.FPU.result EXP:mantR EXP:expR cpuStim.testCpu.FPU.op cpuStim.testCpu.FPU.start cpuStim.testCpu.FPU.valid cpuStim.testCpu.FPU.busy cpuStim.testCpu.FPU.overflow cpuStim.testCpu.FPU.underflow cpuStim.testCpu.FPU.inexact }
...
set _session_group_272 ALU
gui_sg_create "$_session_group_272"
set ALU "$_session_group_272"

gui_sg_addsignal -group "$_session_group_272" { cpuStim.testCpu.aluBlock.ALUFlags cpuStim.testCpu.aluBlock.Result cpuStim.testCpu.aluBlock.adder_out cpuStim.testCpu.aluBlock.temp_op cpuStim.testCpu.aluBlock.a cpuStim.testCpu.aluBlock.b cpuStim.testCpu.aluBlock.SIZE cpuStim.testCpu.aluBlock.ALUControl cpuStim.testCpu.aluBlock.carry }
gui_set_radix -radix {decimal} -signals {V1:cpuStim.testCpu.aluBlock.SIZE}
gui_set_radix -radix {twosComplement} -signals {V1:cpuStim.testCpu.aluBlock.SIZE}

set _session_group_273 FPUWrAddrReg
gui_sg_create "$_session_group_273"
set FPUWrAddrReg "$_session_group_273"


set _session_group_274 Group1
gui_sg_create "$_session_group_274"
set Group1 "$_session_group_274"

gui_sg_addsignal -group "$_session_group_274" { {cpuStim.testCpu.instructionMemory.mem[10]} {cpuStim.testCpu.instructionMemory.mem[9]} {cpuStim.testCpu.instructionMemory.mem[8]} {cpuStim.testCpu.instructionMemory.mem[7]} {cpuStim.testCpu.instructionMemory.mem[6]} {cpuStim.testCpu.instructionMemory.mem[5]} {cpuStim.testCpu.instructionMemory.mem[4]} {cpuStim.testCpu.instructionMemory.mem[3]} {cpuStim.testCpu.instructionMemory.mem[2]} {cpuStim.testCpu.instructionMemory.mem[1]} {cpuStim.testCpu.instructionMemory.mem[0]} }

set _session_group_275 Group2
gui_sg_create "$_session_group_275"
set Group2 "$_session_group_275"

gui_sg_addsignal -group "$_session_group_275" { cpuStim.testCpu.CompOutput }
...
catch { gui_list_select -id ${Data.1} {cpuStim.testCpu.wasFPU }}
gui_view_scroll -id ${Data.1} -vertical -set 1662

...
# DVE full session
# Saved on Fri May 27 16:18:16 2022
# Designs open: 1
...
gui_show_window -window ${TopLevel.3} -show_state normal -rect {{580 108} {1353 850}}
...
set HSPane.1 [gui_create_window -type HSPane -parent ${TopLevel.3} -dock_state left -dock_on_new_line true -dock_extent 424]
catch { set Hier.1 [gui_share_window -id ${HSPane.1} -type Hier] }
gui_set_window_pref_key -window ${HSPane.1} -key dock_width -value_type integer -value 424
gui_set_window_pref_key -window ${HSPane.1} -key dock_height -value_type integer -value 250
gui_set_window_pref_key -window ${HSPane.1} -key dock_offset -value_type integer -value 0
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 423} {height 381} {dock_state left} {dock_on_new_line true} {child_hier_colhier 282} {child_hier_coltype 115} {child_hier_colpd 0} {child_hier_col1 0} {child_hier_col2 1} {child_hier_col3 -1}}
set Console.1 [gui_create_window -type Console -parent ${TopLevel.3} -dock_state bottom -dock_on_new_line true -dock_extent 229]
gui_set_window_pref_key -window ${Console.1} -key dock_width -value_type integer -value 1460
gui_set_window_pref_key -window ${Console.1} -key dock_height -value_type integer -value 229
gui_set_window_pref_key -window ${Console.1} -key dock_offset -value_type integer -value 0
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 773} {height 228} {dock_state bottom} {dock_on_new_line true}}
...
set _session_group_269 cpuControl_testbench
gui_sg_create "$_session_group_269"
set cpuControl_testbench "$_session_group_269"


set _session_group_270 cpuStim_1
gui_sg_create "$_session_group_270"
set cpuStim_1 "$_session_group_270"

gui_sg_addsignal -group "$_session_group_270" { cpuStim.testCpu.clk cpuStim.testCpu.reset cpuStim.testCpu.PC cpuStim.testCpu.PCNext cpuStim.testCpu.instr }
...
set _session_group_271 registers
gui_sg_create "$_session_group_271"
set registers "$_session_group_271"

gui_sg_addsignal -group "$_session_group_271" { }

set _session_group_272 $_session_group_271|
append _session_group_272 registers
gui_sg_create "$_session_group_272"
set registers|registers "$_session_group_272"

gui_sg_addsignal -group "$_session_group_272" { cpuStim.testCpu.registers.MEM cpuStim.testCpu.registers.wr_en cpuStim.testCpu.registers.wr_data cpuStim.testCpu.registers.wr_addr cpuStim.testCpu.registers.rd_addr_0 cpuStim.testCpu.registers.rd_addr_1 cpuStim.testCpu.registers.rd_data_0 cpuStim.testCpu.registers.rd_data_1 }
...
set _session_group_278 FPU
gui_sg_create "$_session_group_278"
set FPU "$_session_group_278"

gui_sg_addsignal -group "$_session_group_278" { cpuStim.testCpu.FPU.opA cpuStim.testCpu.FPU.opB EXP:mantA EXP:mantB EXP:expA EXP:expB }
gui_sg_addsignal -group "$_session_group_278" { Divider } -divider
gui_sg_addsignal -group "$_session_group_278" { cpuStim.testCpu.FPU.result EXP:mantR EXP:expR cpuStim.testCpu.FPU.op cpuStim.testCpu.FPU.overflow cpuStim.testCpu.FPU.underflow cpuStim.testCpu.FPU.inexact cpuStim.testCpu.FPU.FPUFlags }
...
set _session_group_280 ALU
gui_sg_create "$_session_group_280"
set ALU "$_session_group_280"

gui_sg_addsignal -group "$_session_group_280" { cpuStim.testCpu.aluBlock.ALUFlags cpuStim.testCpu.aluBlock.Result cpuStim.testCpu.aluBlock.adder_out cpuStim.testCpu.aluBlock.temp_op cpuStim.testCpu.aluBlock.a cpuStim.testCpu.aluBlock.b cpuStim.testCpu.aluBlock.SIZE cpuStim.testCpu.aluBlock.ALUControl cpuStim.testCpu.aluBlock.carry }
gui_set_radix -radix {binary} -signals {V1:cpuStim.testCpu.aluBlock.Result}
gui_set_radix -radix {unsigned} -signals {V1:cpuStim.testCpu.aluBlock.Result}
gui_set_radix -radix {binary} -signals {V1:cpuStim.testCpu.aluBlock.a}
gui_set_radix -radix {unsigned} -signals {V1:cpuStim.testCpu.aluBlock.a}
...
set _session_group_281 FlagsLatch
gui_sg_create "$_session_group_281"
set FlagsLatch "$_session_group_281"

gui_sg_addsignal -group "$_session_group_281" { cpuStim.testCpu.FlagsLatch.IN cpuStim.testCpu.FlagsLatch.EN cpuStim.testCpu.FlagsLatch.RST cpuStim.testCpu.FlagsLatch.OUT cpuStim.testCpu.FlagsLatch.i }
...
set _session_group_282 Group1
gui_sg_create "$_session_group_282"
set Group1 "$_session_group_282"

gui_sg_addsignal -group "$_session_group_282" { {cpuStim.testCpu.instructionMemory.mem[34]} {cpuStim.testCpu.instructionMemory.mem[33]} {cpuStim.testCpu.instructionMemory.mem[32]} {cpuStim.testCpu.instructionMemory.mem[31]} {cpuStim.testCpu.instructionMemory.mem[30]} {cpuStim.testCpu.instructionMemory.mem[29]} {cpuStim.testCpu.instructionMemory.mem[28]} {cpuStim.testCpu.instructionMemory.mem[27]} {cpuStim.testCpu.instructionMemory.mem[26]} {cpuStim.testCpu.instructionMemory.mem[25]} {cpuStim.testCpu.instructionMemory.mem[24]} {cpuStim.testCpu.instructionMemory.mem[23]} {cpuStim.testCpu.instructionMemory.mem[22]} {cpuStim.testCpu.instructionMemory.mem[12]} {cpuStim.testCpu.instructionMemory.mem[11]} {cpuStim.testCpu.instructionMemory.mem[10]} {cpuStim.testCpu.instructionMemory.mem[9]} {cpuStim.testCpu.instructionMemory.mem[8]} {cpuStim.testCpu.instructionMemory.mem[7]} {cpuStim.testCpu.instructionMemory.mem[6]} {cpuStim.testCpu.instructionMemory.mem[5]} {cpuStim.testCpu.instructionMemory.mem[4]} {cpuStim.testCpu.instructionMemory.mem[3]} {cpuStim.testCpu.instructionMemory.mem[2]} {cpuStim.testCpu.instructionMemory.mem[1]} {cpuStim.testCpu.instructionMemory.mem[0]} }

set _session_group_283 instructionMemory
gui_sg_create "$_session_group_283"
set instructionMemory "$_session_group_283"

gui_sg_addsignal -group "$_session_group_283" { cpuStim.testCpu.instructionMemory.address cpuStim.testCpu.instructionMemory.clk cpuStim.testCpu.instructionMemory.i cpuStim.testCpu.instructionMemory.instruction cpuStim.testCpu.instructionMemory.mem {cpuStim.testCpu.instructionMemory.unnamed$$_0} {cpuStim.testCpu.instructionMemory.unnamed$$_1} {cpuStim.testCpu.instructionMemory.unnamed$$_2} }

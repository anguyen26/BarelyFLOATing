...
# DVE full session
# Saved on Sat May 28 12:43:53 2022
# Designs open: 1
#   V1: vcdplus.vpd
...
#<Session mode="Full" path="/home/projects/ee478.2022spr/hoppii/BarelyFLOATing/fpu/session.vcdplus.vpd.tcl" type="Debug">
...
set HSPane.1 [gui_create_window -type HSPane -parent ${TopLevel.1} -dock_state left -dock_on_new_line true -dock_extent 364]
catch { set Hier.1 [gui_share_window -id ${HSPane.1} -type Hier] }
gui_set_window_pref_key -window ${HSPane.1} -key dock_width -value_type integer -value 364
gui_set_window_pref_key -window ${HSPane.1} -key dock_height -value_type integer -value -1
gui_set_window_pref_key -window ${HSPane.1} -key dock_offset -value_type integer -value 0
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 363} {height 575} {dock_state left} {dock_on_new_line true} {child_hier_colhier 261} {child_hier_coltype 94} {child_hier_colpd 0} {child_hier_col1 0} {child_hier_col2 1} {child_hier_col3 -1}}
set DLPane.1 [gui_create_window -type DLPane -parent ${TopLevel.1} -dock_state left -dock_on_new_line true -dock_extent 389]
catch { set Data.1 [gui_share_window -id ${DLPane.1} -type Data] }
gui_set_window_pref_key -window ${DLPane.1} -key dock_width -value_type integer -value 389
gui_set_window_pref_key -window ${DLPane.1} -key dock_height -value_type integer -value 418
gui_set_window_pref_key -window ${DLPane.1} -key dock_offset -value_type integer -value 0
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 388} {height 575} {dock_state left} {dock_on_new_line true} {child_data_colvariable 194} {child_data_colvalue 105} {child_data_coltype 94} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
...
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 1273} {height 232} {dock_state bottom} {dock_on_new_line true}}
...
gui_update_layout -id ${Wave.1} {{show_state maximized} {dock_state undocked} {dock_on_new_line false} {child_wave_left 498} {child_wave_right 770} {child_wave_colname 260} {child_wave_colvalue 233} {child_wave_col1 0} {child_wave_col2 1}}
...
# Restore C1 time
gui_set_time -C1_only 1236000000
...
catch {gui_list_select -id ${Hier.1} {fpuStim.dut}}
...
gui_list_show_data -id ${Data.1} {fpuStim.dut}
gui_show_window -window ${Data.1}
catch { gui_list_select -id ${Data.1} {fpuStim.dut.result fpuStim.dut.overflow fpuStim.dut.underflow fpuStim.dut.inexact fpuStim.dut.clk fpuStim.dut.reset fpuStim.dut.opA fpuStim.dut.opB fpuStim.dut.op fpuStim.dut.FPUFlags }}
...
gui_open_source -id ${Source.1} /home/projects/ee478.2022spr/hoppii/BarelyFLOATing/fpu/tb_fp_add.sv -startline 1 -replace
...
gui_wv_zoom_timerange -id ${Wave.1} 0 51500000000
...
gui_list_set_insertion_bar  -id ${Wave.1} -group tb_fp_add  -item {fpuStim.dut.op[1:0]} -position below

gui_marker_move -id ${Wave.1} {C1} 1236000000
